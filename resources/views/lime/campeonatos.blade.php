                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col" style="cursor: pointer"><a href="/edit-campeonato/{{ $campeonato->id }}"><i class="material-icons" style="color: orange;">create</i></a></td>
                                        <td>
                                            <form action="/delete-campeonato/{{ $campeonato->id }}" method="POST">
                                                @csrf
                                                @method('delete')
