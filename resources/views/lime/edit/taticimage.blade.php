        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Editar uma Imagem tatica</h5>
                            <form action="/taticimage" method="POST">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="form-row">
                                    <div class="col-md-12 form-group pb-2">
                                        <input type="text" name="imagename" class="form-control" value="{{ $taticimage->imagename }}" placeholder="Nome da imagem" />
                                    </div>
                                    <div class="col-md-12 form-group pb-2">
