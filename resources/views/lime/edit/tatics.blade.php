        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Editar uma tática</h5>
                            <form action="/tatic/{{ $tatic->id }}" method="POST">
                                {{ csrf_field() }}
                                @method('PUT')
                                <div class="form-row">
                                    <div class="col-md-12 form-group pb-2">
                                        <input type="text" name="name" class="form-control" placeholder="Nome da tática" value="{{ $tatic->name }}"/>
                                    </div>
                                    <div class="col-md-12 form-group pb-2">
                                        <textarea type="text" name="description" class="form-control" placeholder="Descrição">{{ $tatic->name }}</textarea>
                                    </div>
