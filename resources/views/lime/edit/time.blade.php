                            ...
                            <form action="/time/{{ $time->id }}" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 form-group pb-2">
                                        <input type="text" name="teamName" class="form-control" placeholder="Nome do time" value="{{ $time->teamName }}"/>
                                    </div>
                                    <div class="col-md-12 form-group pb-2">
                                        <input type="text" name="teamLogo" class="form-control" placeholder="Logo do time" value="{{ $time->teamLogo }}"/>
                                    </div>
                                </div>
