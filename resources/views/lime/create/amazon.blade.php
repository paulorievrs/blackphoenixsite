        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Criar um amazon link</h5>
                            <form action="/amazon" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 form-group pb-2">
                                        <input type="text" name="imgsrc1" class="form-control" placeholder="Imgsrc1"/>
                                    </div>
                                </div>

                                <div class="form-row">
                                    <div class="col-md-12 form-group pb-2">
                                        <input type="text" name="imgsrc2" class="form-control" placeholder="Imgsrc2"/>
                                    </div>
                                </div>

                                <div class="form-row">
                                    <div class="col-md-12 form-group pb-2">
                                        <input type="text" name="ahref" class="form-control" placeholder="ahref"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 form-group pb-2">
                                        <select class="custom-select" name="user_id">
                                            <option selected>Qual o usuário?</option>
