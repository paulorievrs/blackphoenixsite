...
<div class="container" style="padding-top: 100px">
    <div class="col-lg-12">
        <h1>Criar um jogo</h1>
        <hr>
        <form action="/jogos" method="POST" role="form" class="php-email-form">
            {{ csrf_field() }}
            <div class="form-row">
                <div class="col-md-12 form-group pb-2">
                    <input type="text" name="nomeDoTime" class="form-control" placeholder="Nome do Time"/>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-12 form-group pb-2">
                    <input type="text" name="logoDoTime" class="form-control" placeholder="Logo Do time"/>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-12 form-group pb-2">
                    <input type="text" name="campeonato" class="form-control" placeholder="Campeonato"/>
                </div>
            </div>
